    ...
    <form class="formulario-cadastro auth-form" method="POST" action="<?= BASE_URL ?>admin/criar-servico">
        ...
        <span class="inputs flex center">
            ...
            <span class="input flex vertical">
                ...
                <input type="number" name="valor_operacao" id="valor_operacao" step="0.01" min="0" placeholder="Valor da operação" value="<?= htmlspecialchars($old['valor_operacao'] ?? '') ?>" required>
